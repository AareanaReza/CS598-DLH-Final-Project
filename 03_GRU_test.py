...
def parse_arguments():
    ...
    parser.add_argument('--Xinputdata', type=str, default='/content/X-test.data', metavar='<visit_file>')
    parser.add_argument('--Yinputdata', type=str, default='/content/Y-test.data', metavar='<visit_file>')
    parser.add_argument('--inputModel', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/model_output.pt', metavar='<visit_file>')
