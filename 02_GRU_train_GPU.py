...
def load_tensors():
    ...
    vectors_testListX = vectors_trainListX[int(math.ceil(0.7*sizedata)):sizedata]
    vectors_trainListX = vectors_trainListX[0:int(math.ceil(0.7*sizedata))]

    # Create train and test sets for diagnoses
    diagnoses_testListY = diagnoses_trainListY[int(math.ceil(0.7*sizedata)):sizedata]
    diagnoses_trainListY = diagnoses_trainListY[0:int(math.ceil(0.7*sizedata))]
...
def parse_arguments():
    ...
    parser.add_argument('--inputdata', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/prepared_data.npz', metavar='<visit_file>')
    parser.add_argument('--outFile', metavar='out_file', default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/model_output.pt', help='Any file name to store the model.')
