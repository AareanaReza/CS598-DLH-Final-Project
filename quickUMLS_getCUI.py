...
# Global variables
# QuickUMLS object
matcher = QuickUMLS(quickumls_fp='/content/drive/MyDrive/CS598-DLH-Final-Project/QuickUMLS', overlapping_criteria='score', threshold=0.7, similarity_name='cosine', window=5)
#TUIs = TUI_alpha
ARGS = None
# TUI list
...
dirchunks = "/content/drive/MyDrive/CS598-DLH-Final-Project/QuickUMLS/data/chunkssmall/"
diroutputchunks = "/content/drive/MyDrive/CS598-DLH-Final-Project/QuickUMLS/data/outputchunkssmall/"
