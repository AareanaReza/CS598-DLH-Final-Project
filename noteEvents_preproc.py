...
def main():
    ...
    # outpath = "out_results/"
    # os.mkdir(outpath)
    outpath = '/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/'
    noteevents = '/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Original-Data/SAMPLEDNOTEEVENTS.csv'
    # Run preprocessing over the input
    anonimization_remover(noteevents, outpath+'out_noanonim.csv')
