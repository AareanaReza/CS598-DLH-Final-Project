...
def parse_arguments():
	...
	parser.add_argument('--admissions_file', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Original-Data/ADMISSIONS.csv')
	parser.add_argument('--diagnoses_file', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Original-Data/DIAGNOSES_ICD.csv')
	parser.add_argument('--notes_file', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/post_process_output_no_index.csv')
	parser.add_argument('--output_file_name', type=str, default='/content/drive/MyDrive/CS598-DLH-Final-Project/Data-Preprocessing/Output-Data/prepared_data')
